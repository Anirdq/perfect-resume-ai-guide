...
export const DemoAnimation = () => {
  ...
  return (
    <section className="px-4 py-10 flex flex-col items-center animate-fade-in">
      ...
      <div className="relative rounded-2xl bg-white/80 shadow-lg w-full max-w-xl mx-auto p-8 min-h-[200px] flex flex-col items-center">
        <div className="mb-4 flex flex-row justify-center items-center gap-3">
          ...
          <span className="text-xl font-bold text-blue-700">{DEMO_STEPS[step].title}</span>
        </div>
