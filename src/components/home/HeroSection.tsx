...
export const HeroSection = () => {
  ...
  return <section className="text-center px-4 py-16 flex flex-col items-center relative overflow-hidden animate-fade-in my-[50px]">
      ...
      <Button size="lg" className="text-xl font-semibold px-10 py-6 bg-blue-700 hover:bg-blue-800 shadow-2xl animate-pulse transition-all duration-300" onClick={() => navigate("/resume")} aria-label="Upload Resume">
        Upload Resume
      </Button>
